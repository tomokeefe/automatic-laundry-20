  ...
  const values = [
    {
      ...
      description:
        "Remote service tech spots issues early, reducing visits and emissions.",
    },
    {
      icon: <Award className="w-8 h-8 text-laundry-blue" />,
      title: "Ethical Excellence",
      description:
        "Transparent partnerships, no-surprise leasing, and top-tier equipment.",
    },
    {
      icon: <Heart className="w-8 h-8 text-laundry-blue" />,
      title: "Community Focus",
      description:
        "Serving New England and NYC with local hires who know the drill (and the punchlines).",
    },
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-laundry-blue-light to-fresh-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Badge className="mb-4 bg-laundry-blue text-white">Since 1964</Badge>
          <h1 className="text-4xl lg:text-5xl font-bold text-laundry-navy mb-6">
            Our Story: From 1964 to Future-Proof Laundry
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            At Automatic Laundry, we're more than machines – we're a
            family-owned team passionate about making laundry less of a chore
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Founded in 1964 and headquartered in Newton, MA, we've grown
                  from local heroes to Northeast leaders in laundry management.
                  Acquired by industry giants but staying true to our roots, we
                  serve multi-housing properties, colleges, and more with
                  ethical practices and cutting-edge tech.
                </p>
                <p>
                  Laundry might not be glamorous, but we've seen it all – from
                  sock-eating dryers to midnight maintenance calls. That's why
                  we pioneered remote monitoring and the Resident Advantage®
                  coinless system: to give owners peace of mind and residents
                  their weekends back.
                </p>
                <p>
                  We're committed to sustainability (fewer trucks on the road
                  means a cleaner planet) and innovation that actually works.
                  Think of us as the witty wizard in your laundry room: solving
      ...
      <section className="py-16 bg-laundry-navy text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-6">
            We're expanding and hiring – join a team where training leads to
            real benefits and the occasional laundry pun.
          </p>
          <p className="text-gray-300 mb-8">
            We believe in giving back to our community, one clean load at a
            time. When you work with us, you're not just joining a company –
            you're becoming part of a family that's been making life easier for
            decades.
          </p>
