  ...
  const benefits = [
    {
      ...
      title: "Revenue Boost",
      description:
        "Lease our commercial-grade equipment and watch income flow – because quarters add up, but app payments multiply.",
    },
    {
      icon: <Monitor className="w-8 h-8 text-laundry-blue" />,
      title: "Efficiency Edge",
      description:
        "Remote tech means fewer service calls; imagine resolving a glitch from your desk, not the basement. (Who knew laundry could be this hands-off?)",
    },
    {
      icon: <Target className="w-8 h-8 text-laundry-blue" />,
      title: "Custom Fit",
      description:
        "Tailored for multi-housing, condos, and campuses – ethical leases that respect your budget and boost tenant retention.",
    },
    {
      icon: <CheckCircle className="w-8 h-8 text-laundry-blue" />,
      title: "The Proof",
      description:
        '"Automatic Laundry transformed our OPL from a cost center to a cash cow – reliable and refreshingly straightforward." – Property Manager, Boston.',
    },
  ];
      ...
      <section className="bg-gradient-to-br from-laundry-blue to-laundry-blue-dark text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Property owners, you get it: Tenants need clean sheets, but you need
            steady streams – of revenue, not water. At Automatic Laundry, we
            specialize in turning underused spaces into profit powerhouses.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <div className="space-y-4 text-gray-600">
                <p>
                  Our on-premise laundry (OPL) solutions cut costs by up to 55%
                  on labor and linens, while our leasing and management services
                  handle the heavy lifting. No more jammed machines or outdated
                  coins – just seamless app integrations and remote monitoring
                  that keeps everything running smoothly.
                </p>
                <p>
                  Ready to wash away operational woes? Our experts will audit
                  your setup and show you the savings. No fluff, just facts (and
                  maybe a dry joke about shrinkage rates).
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-laundry-navy">
                    55%
                  </div>
      ...
      <section className="py-16 bg-laundry-blue-light">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <blockquote className="text-2xl font-medium text-laundry-navy mb-6">
            "Automatic Laundry transformed our OPL from a cost center to a cash
            cow – reliable and refreshingly straightforward."
          </blockquote>
          <cite className="text-gray-600">– Property Manager, Boston</cite>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our experts will audit your setup and show you the savings. No
              fluff, just facts (and maybe a dry joke about shrinkage rates).
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <Label htmlFor="message">
                    Tell us about your laundry challenges
                  </Label>
                  <Textarea
                    id="message"
                    name="message"
      ...
      <section className="py-16 bg-laundry-navy text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join hundreds of property owners who've transformed their laundry
            operations with Automatic Laundry
          </p>
